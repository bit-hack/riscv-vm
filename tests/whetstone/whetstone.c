...
#define ITERATIONS	WORKLOAD /* (1000) 1 Million Whetstone instructions */
...
TYPE		x1, x2, x3, x4, x, y, z, t, t1, t2;
TYPE 		e1[4];
...
void whetstone(void)
{
	printf ("Whetstone Benchmark - C language version\n\n");
	cputime (&time0);
